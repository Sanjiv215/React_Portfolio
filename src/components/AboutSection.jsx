  ...
  return (
    <section id="about" className="py-10 sm:py-16 px-3 sm:px-4 relative z-10 max-w-5xl mx-auto">
      <WindowFrame title="Finder — About Sanjiv Prasad" icon={Folder}>
        ...
        <div className="p-4 sm:p-8 rounded-2xl bg-zinc-900/60 border border-white/10 mb-6 sm:mb-8 relative overflow-hidden">
          <div className="flex flex-col lg:flex-row items-start lg:items-center gap-5 sm:gap-6 justify-between">
            ...
            <div className="flex flex-col sm:flex-row items-start gap-4 sm:gap-5 max-w-2xl">
              <div className="shrink-0 w-16 h-16 sm:w-24 sm:h-24 rounded-2xl overflow-hidden border-2 border-white/15 shadow-xl bg-zinc-800">
                <img
              ...
              <div className="space-y-2.5 sm:space-y-3">
                ...
                <div className="flex flex-wrap gap-1.5 sm:gap-2 pt-2">
                  <span className="px-2 sm:px-2.5 py-0.5 sm:py-1 rounded-full bg-white/5 border border-white/10 text-zinc-300 text-[11px] sm:text-xs font-mono">
            ...
            <div className="shrink-0 p-4 sm:p-5 rounded-2xl bg-zinc-950 border border-white/10 text-center w-full lg:w-48 mt-2 lg:mt-0">
